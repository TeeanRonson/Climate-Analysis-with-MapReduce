...
public class GeoHashPrefix {
    public static void main(String[] args) {
        ...
        try {
            ...
            /* Current class */
            job.setJarByClass(GeoHashPrefix.class);

            /* Mapper class */
            job.setMapperClass(GeoHashPrefixMapper.class);
            ...
            /* Reducer class */
            job.setReducerClass(GeoHashPrefixReducer.class);
