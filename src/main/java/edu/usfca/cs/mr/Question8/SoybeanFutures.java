...
public class SoybeanFutures {
    public static void main(String[] args) {
        ...
        try {
            ...
            Job job = Job.getInstance(conf, "Soybean Futures job");

            /* Current class */
            job.setJarByClass(SoybeanFutures.class);

            /* Mapper class */
            job.setMapperClass(SoybeanFuturesMapper.class);
            ...
            /* Reducer class */
            job.setReducerClass(SoybeanFuturesReducer.class);
